...
def _load_history_ns():
    ...
    import holographic.mesh_and_geometry.holographic_mesh as _hm
    ns["Mesh"] = _StubMesh; _hm.Mesh = _StubMesh
    ns["_MIND"] = None
    for fn in ("_mind", "_history", "_push_snapshot", "_discard_snapshot",
