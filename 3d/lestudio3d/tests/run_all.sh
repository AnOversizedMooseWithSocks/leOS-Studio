...
run "lews bridge (real engine)" sh -c 'PYTHONHASHSEED=0 python3 tests/lews_bridge_test.py'
run "scene document (real engine)" sh -c 'PYTHONHASHSEED=0 python3 tests/scene_doc_test.py'
