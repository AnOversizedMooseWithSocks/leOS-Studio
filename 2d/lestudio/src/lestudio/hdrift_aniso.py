"""Anisotropic colour-splat codec for HDRIFT v2 (R28).
...
# The drift itself stays in the server (it needs leCore on the path and
# the document's layers); this module is the pure fitter/decoder.
